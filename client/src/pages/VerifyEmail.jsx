    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-gradient-to-br from-moris-50 via-yellow-50 to-orange-50 dark:from-dark-950 dark:via-dark-900 dark:to-dark-950">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md">
        <div className="glass-card p-8 md:p-10 text-center">
          {status === 'loading' && (
            <div>
              <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-moris-500 mx-auto mb-6"></div>
              <h1 className="text-2xl font-bold font-display text-gradient mb-2">Verifying your email...</h1>
          ...
          {status === 'success' && (
            <div>
              ...
              <h1 className="text-2xl font-bold font-display text-gradient mb-2">Email Verified!</h1>
          ...
          {status === 'error' && (
            <div>
              ...
              <h1 className="text-2xl font-bold font-display text-gradient mb-2">Verification Failed</h1>
              <p className="text-gray-500 mb-6">{message}</p>
