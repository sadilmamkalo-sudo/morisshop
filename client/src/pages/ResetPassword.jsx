      ...
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md">
        <div className=" p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-ink-500 dark:text-ink-400 mt-2">Enter your new password</p>
          </div>
          {success ? (
            <div className="text-center">
              ...
              <p className="text-ink-600 dark:text-ink-400 mb-6">Your password has been reset successfully.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" className="input" required minLength={6} />
              </div>
              <div>
                <label className="block text-sm font-medium mb-2">Confirm Password</label>
                <input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="••••••••" className="input" required minLength={6} />
              </div>
