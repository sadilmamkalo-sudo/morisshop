        ...
        <div className="glass-card p-8 md:p-10 text-center">
          {subscribed ? (
            <div>
              ...
              <h1 className="text-2xl font-bold font-display text-gradient mb-2">You're subscribed!</h1>
              <p className="text-gray-500">Thank you for subscribing to our newsletter.</p>
            </div>
          ) : (
            <>
              ...
              <h1 className="text-3xl font-bold font-display text-gradient mb-2">Newsletter</h1>
              <p className="text-gray-500 dark:text-gray-400 mb-6">Subscribe to get the latest updates and offers</p>
