...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold shadow-lg animate-pulse-glow">1</div>
    </a>
  );
}
